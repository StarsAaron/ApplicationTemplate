...
public class FancyButton extends LinearLayout {
     ...
     * @return
     */
    public static FancyButton init(Context context){
        return new FancyButton(context);
    }
    ...
    @SuppressLint("NewApi")
    private FancyButton setupBackground() {
        // Default Drawable
     ...
     * @param text : Text
     */
    public FancyButton setText(String text) {
     ...
     */
    public FancyButton setTextAllCaps(boolean textAllCaps) {
     ...
     */
    public FancyButton setTextColor(int color) {
     ...
     * @param color : Color
     */
    public FancyButton setIconColor(int color) {
        if (mFontIconView != null) {
     ...
     */
    public FancyButton setDefaultBackgroundColor(int color) {
     ...
     * @param color : use Color.parse('#code')
     */
    public FancyButton setFocusBackgroundColor(int color) {
     ...
     */
    public FancyButton setTextSize(int textSize) {
    ...
    public FancyButton setTextGravity(int gravity) {
     ...
     */
    public FancyButton setIconPadding(int paddingLeft, int paddingTop, int paddingRight, int paddingBottom) {
     ...
     */
    public FancyButton setIconResource(int drawable) {
     ...
     */
    public FancyButton setIconResource(Drawable drawable) {
     ...
     */
    public FancyButton setIconResource(String icon) {
        this.mFontIcon = icon;
        if (mFontIconView == null) {
            mIconView = null;
            initializeFancyButton();
     ...
     */
    public FancyButton setFontIconSize(int iconSize) {
     ...
     */
    public FancyButton setIconPosition(int position) {
     ...
     *              use Color.parse('#code')
     */
    public FancyButton setBorderColor(int color) {
     ...
     * @param width : Width
     */
    public FancyButton setBorderWidth(int width) {
     ...
     * @param radius : Radius
     */
    public FancyButton setRadius(int radius) {
        this.mRadius = radius;
        if (mIconView != null || mFontIconView != null || mTextView != null) {
            this.setupBackground();
        }
     ...
     *
     * @param fontPathName : fontPathName
     *                 Place your text fonts in assets
     */
    public FancyButton setCustomTextFont(String fontPathName) {
        mTextTypeFace = Utils.findFont(mContext, fontPathName, mDefaultTextFont);
     ...
     */
    public FancyButton setCustomIconFont(String fontName) {
     ...
     * @param ghost
     */
    public FancyButton setGhost(boolean ghost) {
        this.mGhost = ghost;
