package com.aaron.applicationtemplate.data.local.test;

import android.test.AndroidTestCase;

import com.aaron.applicationtemplate.data.local.DatabaseHelper;
import com.aaron.applicationtemplate.data.local.dao.ArticleDao;
import com.aaron.applicationtemplate.data.local.dao.UserDao;
import com.aaron.applicationtemplate.data.local.entity.Article;
import com.aaron.applicationtemplate.data.local.entity.Student;
import com.aaron.applicationtemplate.data.local.entity.User;
