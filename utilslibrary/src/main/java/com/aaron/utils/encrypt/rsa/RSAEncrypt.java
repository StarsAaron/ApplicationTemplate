...
public class RSAEncrypt {
    ...
    public static void genKeyPair(String filePath) {
        ...
        try {
            ...
            // 将密钥对写入到文件
            String PublicKeyFilePath = filePath + File.separator + PublicKeyFileName;
            String PrivateKeyFilePath = filePath + File.separator + PrivateKeyFileName;

            CreateFileUtil.createFile(PublicKeyFilePath);
            CreateFileUtil.createFile(PrivateKeyFilePath);
    ...
    public static String loadPublicKeyByFile(String path) throws Exception {
        try {
            CreateFileUtil.createFile(path + File.separator + PublicKeyFileName);
            BufferedReader br = new BufferedReader(new FileReader(path + File.separator + PublicKeyFileName));
    ...
    public static String loadPrivateKeyByFile(String path) throws Exception {
        try {
            BufferedReader br = new BufferedReader(new FileReader(path + File.separator + PrivateKeyFileName));
            String readLine = null;
            StringBuilder sb = new StringBuilder();
            while ((readLine = br.readLine()) != null) {
                sb.append(readLine);
