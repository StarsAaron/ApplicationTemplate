...
public class SPUtils2 {
    ...
    private static SPUtils2 prefsUtils;

    private SPUtils2(Context context, String fileName) {
        this.FILE_NAME = fileName;
        sp = context.getSharedPreferences(fileName, Context.MODE_PRIVATE);
        editor = sp.edit();
    }

    public static SPUtils2 getInstance(Context context, String fileName) {
        if (prefsUtils == null) {
            prefsUtils = new SPUtils2(context, fileName);
        }
        return prefsUtils;
    }
