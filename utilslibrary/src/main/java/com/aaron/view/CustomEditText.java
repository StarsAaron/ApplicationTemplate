...
public class CustomEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    private void initAttribute(Context context, AttributeSet attrs) {
        ...
        //***********  a. 点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_clickResID = typedArray.getResourceId(R.styleable.CustomEditText_ic_left_click, R.drawable.ic_left_click);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        ic_left_click = getResources().getDrawable(ic_left_clickResID);
        // 3. 设置图标大小
        // 起点(x，y)、宽= left_width、高 = left_height
        left_x = typedArray.getInteger(R.styleable.CustomEditText_left_x, 0);
        left_y = typedArray.getInteger(R.styleable.CustomEditText_left_y, 0);
        left_width = typedArray.getInteger(R.styleable.CustomEditText_left_width, 60);
        left_height = typedArray.getInteger(R.styleable.CustomEditText_left_height, 60);
        ...
        // **********   b. 未点击状态的左侧图标
        // 1. 获取资源ID
        ic_left_unclickResID = typedArray.getResourceId(R.styleable.CustomEditText_ic_left_unclick, R.drawable.ic_left_unclick);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
         ...
         */
        // 1. 获取资源ID
        ic_deleteResID = typedArray.getResourceId(R.styleable.CustomEditText_ic_delete, R.drawable.delete);
        // 2. 根据资源ID获取图标资源（转化成Drawable对象）
        ic_delete = getResources().getDrawable(ic_deleteResID);
        // 3. 设置图标大小
        // 起点(x，y)、宽= left_width、高 = left_height
        delete_x = typedArray.getInteger(R.styleable.CustomEditText_delete_x, 0);
        delete_y = typedArray.getInteger(R.styleable.CustomEditText_delete_y, 0);
        delete_width = typedArray.getInteger(R.styleable.CustomEditText_delete_width, 60);
        delete_height = typedArray.getInteger(R.styleable.CustomEditText_delete_height, 60);
        ...
        // 原理：通过 反射机制 动态设置光标
        // 1. 获取资源ID
        cursor = typedArray.getResourceId(R.styleable.CustomEditText_cursor, R.drawable.cursor);
        try {
        ...
        lineColor_click = typedArray.getColor(R.styleable.CustomEditText_lineColor_click, lineColorClick_default);
        lineColor_unclick = typedArray.getColor(R.styleable.CustomEditText_lineColor_unclick, lineColorunClick_default);
        ...
        // 3. 分割线位置
        linePosition = typedArray.getInteger(R.styleable.CustomEditText_linePosition, 1);
        // 消除自带下划线
